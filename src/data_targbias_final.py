...
class dataset(Dataset):
    ...
    def load(self, subj):
        ...
        if self.transform == 'True':
            image_transformer = ImageTransformer(rotation_range=180, shift_range=0.,shear_range=0.2,zoom_range=0.,crop_size=None,fill_mode='nearest',cval=0.,flip=False, seed=None, return_affine=False, return_affine_params=False, track_flip_number=False, chan_axis=2)
