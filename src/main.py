...
def pred_model(val_file, checkpoint_file):
    ...
    with open(val_file, 'r') as f:
        for l in f.readlines():
            ...
            predict(model, val_loader, device, paths[0], outpath)
            break
...
def test_model(val_file, checkpoint_file):
    ...
    val_loss = test(model, val_loader, device, save_output=True)
...
def main():
    ...
    train_file = '/nfs/masi/kanakap/projects/DeepN4/src/train.csv'
    val_file = '/nfs/masi/kanakap/projects/DeepN4/src/val.csv'

    model_dir = '/nfs/masi/kanakap/projects/DeepN4/src/unet_trained_model'
    fcheckpoint = '/nfs/masi/kanakap/projects/DeepN4/src/checkpoint_epoch_145'
    if not os.path.isdir(model_dir):
        os.mkdir(model_dir)

    # train_model(train_file, val_file, model_dir)
    ...
    # pred_model(val_file, '{}/{}'.format(model_dir, fcheckpoint))
